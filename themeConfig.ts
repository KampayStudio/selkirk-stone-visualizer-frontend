...
import logo from '@images/selkirk-logo-full.png'
...
export const { themeConfig, layoutConfig } = defineThemeConfig({
  app: {
    ...
    logo: h('img', { src: logo, alt: 'company-logo', style: 'max-height: 2rem' }),
    contentWidth: ContentWidth.Boxed,
    contentLayoutNav: AppContentLayoutNav.Horizontal,
    overlayNavFromBreakpoint: breakpointsVuetify.sm + 16, // 16 for scrollbar. Docs: https://next.vuetifyjs.com/en/features/display-and-platform/
    enableI18n: false,
    theme: 'system',
    isRtl: false,
    skin: Skins.Default,
